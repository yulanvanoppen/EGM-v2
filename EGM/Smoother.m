classdef Smoother < handle                                              % Bspline smoother (from https://github.com/yulanvanoppen/GMGTS)
    ...
    methods
        ...
        function place_knots(obj)                                       % Knot placement heuristic
            ...
            if size(dy, 3) > 1
                ...
                zscore_dy = mean(dy, 3) ./ std(dy, 0, 1);                       % normalized mean slopes and curvature estimates
                zscore_ddy = mean(ddy, 3) ./ std(ddy, 0, 1);
            end
